...
class Header extends Component {
    ...
    render() {
        return (
            <div>
                <h1>Home Page</h1>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A commodi consequuntur est magni nobis
                    omnis provident quam ratione tempora velit. Modi perspiciatis quia rerum? Expedita in iste minima
                    tempora vero.</p><p>A assumenda beatae dignissimos earum enim, exercitationem facere illo iste
                ...
                <p>Corporis culpa cumque debitis, distinctio eius eveniet facere impedit in iste maiores minus nam nemo
                    nihil nisi officia, porro quae quis quos repellendus sit, totam veniam veritatis vero vitae
                    voluptatibus!</p>
            </div>
        );
    }
